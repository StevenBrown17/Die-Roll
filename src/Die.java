...
public class Die extends JPanel
{
	...
	public void roll(){
		...
		repaint();//anytime you make changes that will alter the way objects look on the screen, you need to repaint
	}
	...
	public void paintComponent(Graphics g){
		...
		case 1: g.fillOval(21, 21, 6, 6); break;
		
		case 4: g.fillOval(13, 29, 6, 6);
				g.fillOval(29, 13, 6, 6);
				
		case 2: g.fillOval(13, 13, 6, 6);
				g.fillOval(29, 29, 6, 6);break;
				
		case 5: g.fillOval(33, 9, 6, 6);
				g.fillOval(9, 33, 6, 6);
		case 3: g.fillOval(9, 9, 6, 6);
				g.fillOval(21, 21, 6, 6);
				g.fillOval(33, 33, 6, 6);break;
				
		case 6: g.fillOval(13, 9, 6, 6);
				g.fillOval(13, 21, 6, 6);
				g.fillOval(13, 33, 6, 6);
				g.fillOval(29, 9, 6, 6);
				g.fillOval(29, 21, 6, 6);
				g.fillOval(29, 33, 6, 6);break;
